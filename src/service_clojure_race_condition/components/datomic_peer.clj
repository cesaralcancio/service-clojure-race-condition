(ns service-clojure-race-condition.components.datomic-peer
  (:require [com.stuartsierra.component :as component]
            [service-clojure-race-condition.datomic.peer.peer-transactions :as datomic.peer-transactions]
...
(defrecord Datomic []
  ...
  (start [this]
    (let [_ (datomic.peer/create-database! datomic.peer/base-uri datomic.peer/db-name-transactions)
          ...
          _ (datomic.peer/create-schema! conn datomic.peer-transactions/transaction-schema)
          datomic {:conn conn}]
